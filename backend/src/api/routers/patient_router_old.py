...
from src.infraestructure.dto import patient_dto as patient_schema
from src.infraestructure.database.session import SessionLocal
from src.infraestructure.entities.patient_entity import Patient as model
